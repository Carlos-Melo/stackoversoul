...
const routes: Routes = [
  ...
  { path: 'login', loadChildren: () => import('./modules/acess/acess.module').then(m => m.AcessModule) },
  { path: 'cadastro', loadChildren: () => import('./modules/acess/acess.module').then(m => m.AcessModule)},
